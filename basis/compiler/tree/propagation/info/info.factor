...
CONSTANT: null-info T{ value-info-tuple f null empty-interval }

CONSTANT: object-info T{ value-info-tuple f object full-interval }
...
: <value-info> ( -- info ) \ value-info-tuple new ;
