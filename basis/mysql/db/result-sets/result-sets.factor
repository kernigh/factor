...
combinators db.result-sets destructors kernel locals
mysql.db.connections mysql.db.ffi mysql.db.lib libc
...
M:: mysql-db-connection statement>result-set ( statement -- result-set )
    ...
    [
        ...
        #columns malloc-MYSQL_BIND-array |free :> binds
        #columns malloc-ulong-array |free :> lengths
        #columns malloc-bool-array |free :> is_nulls
        #columns malloc-bool-array |free :> errors
