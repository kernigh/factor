...
USING: arrays ascii.categories assocs hashtables io.encodings.ascii
io.files kernel math math.parser namespaces make sequences sequences.private
sorting splitting grouping strings sets accessors project-euler.common ;
...
: source-059 ( -- seq )
    ...
    ascii file-contents [ whitespace? ] trim-tail "," split
    [ string>number ] map ;
